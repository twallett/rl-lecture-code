...
class GridWorldEnv(gym.Env):
    ...
    def render(self):
        ...
        for row in range(self.size):
            for col in range(self.size):
                ...
                for direction in directions:
                    ...
                    for action in range(q.shape[0]):  # Iterate over actions
                        q_value_text = f"{q[action, row, col]:.2f}"
                        q_text_surface = value_font.render(q_value_text, False, (0, 0, 0))  # Set the second argument to True for anti-aliasing
                        ...
                        frame.blit(q_text_surface, (text_x, text_y))
        ...
        title = font.render(f'Monte Carlo Exploring Starts Qπ(s,a)', True, 0)
